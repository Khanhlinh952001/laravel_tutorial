    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="/" class="-m-1.5 p-1.5">
          ...
          <span class="text-2xl font-bold text-indigo-600">ShopName</span>
        </a>
      </div>
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <a href="/categories" class="text-sm/6 font-semibold text-gray-900">Categories</a>
        <a href="/new-arrivals" class="text-sm/6 font-semibold text-gray-900">New Arrivals</a>
        <a href="/sale" class="text-sm/6 font-semibold text-gray-900">Sale</a>
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-x-6">
        <a href="/search" class="text-gray-700">
        ...
        <a href="/cart" class="text-gray-700 relative">
          ...
          <span class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full size-5 flex items-center justify-center text-xs">0</span>
        </a>
