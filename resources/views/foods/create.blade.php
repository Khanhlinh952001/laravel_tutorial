                ...
                <div class="max-w-md mx-auto">
                    <div class="flex items-center space-x-5">
                        <div class="block pl-2 font-semibold text-xl text-gray-700">
                            <h1 class="leading-relaxed">Create Food Information</h1>
                        </div>
                    </div>

                    <form action="/foods" method="post" class="divide-y divide-gray-200" enctype="multipart/form-data"> 
                        @csrf
                        ...
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div class="flex flex-col">
                                <label for="image_path" class="leading-loose">Image</label>
                            ...
                            <div class="flex flex-col">
                                ...
                                <textarea id="description" name="description" required
                                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 h-32"></textarea>
                            </div>
                        </div>
